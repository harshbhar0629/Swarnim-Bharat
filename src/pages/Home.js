...
const Home = () => {
	return (
		<>
			{/* ================== hero section start =================== */}
			<section style={{ backgroundColor: "rgb(245, 240, 240)" }}>
				<Container>
					<Row>
						<Col lg="6">
							<div className="hero__content">
								...
								<p>
									...
									wisdom, diverse cultural practices, and artistic
									brilliance.India has given birth to a wealth of art forms,
									including classical music, dance, and architecture. The
									country's traditions are equally diverse, with each region
									celebrating its unique festivals and rituals. This heritage
									continues to shape the nation's identity and leaves an
